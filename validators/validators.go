...
func StatusValidators(validStatuses ...string) []interface{} {
	return []interface{}{
...
func SourceTypeValidators() []interface{} {
	return []interface{}{
...
func RealmValidators() []interface{} {
	return []interface{}{
...
// Accepts: "true", "false"
func BooleanStringValidators() []interface{} {
	return []interface{}{
...
func ProviderValidators(providers ...string) []interface{} {
	return []interface{}{
...
func RoleValidators(roles ...string) []interface{} {
	return []interface{}{
...
func URLProtocolValidators() []interface{} {
	return []interface{}{
...
func AuthenticationMethodValidators() []interface{} {
	return []interface{}{
...
func EnvironmentValidators() []interface{} {
	return []interface{}{
...
func SortOrderValidators() []interface{} {
	return []interface{}{
...
func SeverityValidators() []interface{} {
	return []interface{}{
